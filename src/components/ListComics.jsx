...
const ListComics = () => {
    ...
    return <div className="container card ">
        ...
        <ComcicCard title={comics[3].series} image={comics[3].thumb} />
        <ComcicCard title={comics[4].series} image={comics[4].thumb} />
        <ComcicCard title={comics[5].series} image={comics[5].thumb} />
        <ComcicCard title={comics[6].series} image={comics[6].thumb} />
        <ComcicCard title={comics[7].series} image={comics[7].thumb} />
        <ComcicCard title={comics[8].series} image={comics[8].thumb} />
